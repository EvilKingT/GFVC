...
if __name__ == "__main__":
    ...
    dec_dir = f"../../experiment/HEVC/{input_format}/dec/"
    ...
    if input_format=='RGB444':
        for qp in qplist:
            for seq in seqlist:
                os.system("./hevc/decode_rgb444.sh "+test_dataset+'_'+seq+" "+qp+" "+enc_dir+" "+dec_dir+" "+str(width)+" "+str(height)+' &')   ########################
        ...
        for qp in tqdm(qplist):
            for seq in tqdm(seqlist):
                print(seq+"_"+qp+" submited") 
                os.system("./hevc/decode_yuv420.sh "+test_dataset+'_'+seq+" "+qp+" "+enc_dir+" "+dec_dir+" " + str(width)+" "+str(height))   ########################
